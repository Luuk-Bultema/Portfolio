...
<div id="contact"<form><big><b><h1>Project overzicht:</b><big/></form></h1>
<?php
...
try {
    ...
    foreach($res as $rij)
    {
        ...
        echo "<tr><td><a style='color:white; text-decoration: underline;' target='_blank' href='codeoverzicht.php?pid=".$rij->pid."'>$rij->projectnaam</a></td></tr>";
